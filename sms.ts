...
import { StudentData, Data } from "./datatypes-files.js";
...
const StudentDataList: StudentData[] = [];
    ...
    while (continueAdding) {
        const Datalist:Data = await inquirer.prompt([
            {
        ...
        if (Datalist.Studentlist === "Add Student Name and ID") {
            ...
            while (continuenameandid) {
                const studentNameandID:Data = await inquirer.prompt([
                    {
                ...
                const studentfeepaidornot:Data = await inquirer.prompt([
                    {
                ...
                const student = new StudentData(
                    studentNameandID.Student_Name,
                    studentNameandID.student_UniqueID,
                    Student_Random_Courses(),
                    Student_Random_Balance(),
                    studentfeepaidornot.Pay_tuition_Fees === "Paid" ? "Active" : "Inactive",
                    studentfeepaidornot.Pay_tuition_Fees === "Paid"
                );
